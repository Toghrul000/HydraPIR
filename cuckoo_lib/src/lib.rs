...
const MAX_ALLOWED_HASHES: usize = 30; //This is a limit I set for rehash_loop
...
impl<const N: usize> CuckooHashTableBucketed<N> {
    ...
    pub fn insert_tracked(
        ...
        // // We dont need to check if it already exists here since this function is used in initial DB population, no extra check overhead needed.
